              ...
              <div className="p-6 sm:p-8">
                ...
                {!isLogin && (
                  <form onSubmit={handleRegister} className="space-y-5">
                    ...
                    <button type="button" onClick={() => authClient.signIn.social({ provider: "google", callbackURL: "/choose-role" })} className="w-full h-11 flex items-center justify-center gap-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
