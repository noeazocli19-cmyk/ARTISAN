...
const SYSTEM_PROMPT = `Tu es l'assistant virtuel d'Finda, une plateforme qui connecte les clients avec des artisans qualifiés en Afrique.`
...
const KNOWLEDGE_BASE: { keywords: string[]; response: string }[] = [
  ...
  },
  {
    ...
    response: 'Voici les catégories d\'artisans disponibles sur Finda :\n\n🔧 Plomberie\n💡 Électricité\n🪚 Menuiserie\n🎨 Peinture\n🔑 Serrurerie\n🧱 Maçonnerie\n❄️ Climatisation\n🧽 Nettoyage\n👗 Couture\n🍰 Pâtisserie\n🔧 Mécanique\n💇 Coiffure\n\nQuelle catégorie vous intéresse ?'
  },
  {
...
function findResponse(message: string): string {
  ...
  return `Je suis l'assistant Finda. 🤖
