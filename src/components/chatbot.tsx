...
const WELCOME_MESSAGE = 'Bonjour ! 👋 Je suis l\'assistant Finda. Comment puis-je vous aider à trouver l\'artisan idéal ?'
          ...
          >
            ...
            <div className="flex items-center justify-between bg-gradient-to-r from-brand-500 to-brand-600 p-4 text-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm">Assistant Finda</p>
